...
import ir.ac.kntu.ticketing.config.audit.AuditEventConverter;
import ir.ac.kntu.ticketing.domain.PersistentAuditEvent;
...
import static ir.ac.kntu.ticketing.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
